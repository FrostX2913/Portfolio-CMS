...
<div class="outer-container">
	<div class="container">
    	<div class="row">
        	<div class="col">
           		<ul class="breadcrumbs flex align-items-center">
                	...
                	<li><a href="panel.php">Portfolio Edit</li>
            	</ul><!-- .breadcrumbs -->
            </div><!-- .col -->
       	</div><!-- .row -->
		...
		<div class="row list-row">
			<div class="col">
				<a class= "button" href="<?php echo BASE_URL; ?>add.php">New Image</a>
			                ...
			                <div class="portfolio-content">
			                    ...
			                    <div class="entry-content flex flex-column align-items-center justify-content-center">
			                        ...
			                        <ul class="flex flex-wrap justify-content-center">
			                            <li><a href="<?php echo BASE_URL; ?>edit.php?id=<?php echo escape($page['id']); ?>">Edit</a></li>
			                            <li><a href="<?php echo BASE_URL; ?>delete.php?id=<?php echo escape($page['id']);?>">Delete</a></li>
			                        </ul>
			                    	<?php endif; ?>
			                    </div><!-- .entry-content -->
